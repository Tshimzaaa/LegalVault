...
def create_fallback_clause(
    ...
    return service.create_clause(current_user.firm_id, current_user.id, request)
...
def list_fallback_clauses(
    ...
    service = FallbackClauseService(db)
    return service.list_clauses(current_user.firm_id)
...
def update_fallback_clause(
    ...
    service = FallbackClauseService(db)
    return service.update_clause(clause_id, current_user.firm_id, current_user.id, request)
...
def delete_fallback_clause(
    ...
    service = FallbackClauseService(db)
    service.delete_clause(clause_id, current_user.firm_id, current_user.id)
...
def list_client_fallback_clauses(
    ...
    service = FallbackClauseService(db)
    return service.list_clauses(firm_id)
